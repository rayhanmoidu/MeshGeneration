...
ParallelogramQuadtree::ParallelogramQuadtree(int screenWidth, int screenHeight, int cellToTraingleSizeRatio, float (*func)(float, float), int probingValue, float oX, float oY) : Quadtree() {
    hBound = screenWidth;
    vBound = screenHeight;
    gridSizeLimit = 0;
